...
module.exports = class UserInfo extends Command {
	...
	async run(message, args) {
		...
		const statuses = {
			online: this.bot.emojis.get("577175605787885574"),
			idle: this.bot.emojis.get("577175581876158485"),
			offline: this.bot.emojis.get("577175538901319709"),
			dnd: this.bot.emojis.get("577175469443645471"),
		};
